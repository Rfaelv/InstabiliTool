class C2Profile:
        ...
        if loadType['bending'] and 'points' in loadProps:
            if loadProps['points'] == 3:
                ...
                if self.connectionsIsNotRigid:
                    ...
                    self.mapdl.k(33, 0, 0, 0)
                    self.mapdl.k(44, 0, self.bw, 0)
                    self.mapdl.k(55, self.bf, self.bw, 0)
                ...
                if self.connectionsIsNotRigid:
                    self.mapdl.k(122, self.bf, 0, self.L/2)
                    self.mapdl.k(133, 0, 0, self.L/2)
                    self.mapdl.k(144, 0, self.bw, self.L/2)
                    self.mapdl.k(155, self.bf, self.bw, self.L/2)
                ...
                if self.connectionsIsNotRigid:
                    self.mapdl.k(222, self.bf, 0, self.L)
                    self.mapdl.k(233, 0, 0, self.L)
                    self.mapdl.k(244, 0, self.bw, self.L)
                    self.mapdl.k(255, self.bf, self.bw, self.L)
                ...
                if self.connectionsIsNotRigid:
                    ...
                    self.mapdl.k(133, 0, 0, self.Lshear)
                    self.mapdl.k(144, 0, self.bw, self.Lshear)
                    self.mapdl.k(155, self.bf, self.bw, self.Lshear)
                ...
                if self.connectionsIsNotRigid:
                    ...
                    self.mapdl.k(233, 0, 0, self.L - self.Lshear)
                    self.mapdl.k(244, 0, self.bw, self.L - self.Lshear)
                    self.mapdl.k(255, self.bf, self.bw, self.L - self.Lshear)
                ...
                if self.connectionsIsNotRigid:
                    ...
                    self.mapdl.k(333, 0, 0, self.L)
                    self.mapdl.k(344, 0, self.bw, self.L)
                    self.mapdl.k(355, self.bf, self.bw, self.L)
            ...
            if self.connectionsIsNotRigid:
                ...
                self.mapdl.k(133, 0, 0, self.L)
                self.mapdl.k(144, 0, self.bw, self.L)
                self.mapdl.k(155, self.bf, self.bw, self.L)
    ...
    def setBendingLoad(self, bendingLoadProperties):
        if 'points' in bendingLoadProperties:
            ...
            self.mapdl.fk(107, direction, 1)
            self.mapdl.fk(7, direction, - 1)
    ...
    def setNormalLoad(self, normalLoadProperties):
        if normalLoadProperties["type"] == "distributed":
            ...
            self.mapdl.fk(107, "MX", ey)
            self.mapdl.fk(107, "MY", ex)
            self.mapdl.fk(7, "FZ", 1)
            self.mapdl.fk(7, "MX", - ey)
            self.mapdl.fk(7, "MY", - ex)

    def setNewBendingLoad(self, bendingLoadProperties, newLoad):
        if 'points' in bendingLoadProperties:
            if bendingLoadProperties["points"] == 4:
                self.mapdl.fk(104, "FY", -newLoad)
                self.mapdl.fk(204, "FY", -newLoad)

            elif bendingLoadProperties["points"] == 3:
                self.mapdl.fk(104, "FY", -newLoad)
        else:
            direction = 'M' + bendingLoadProperties["direction"]
            self.mapdl.fk(107, direction, newLoad)
            self.mapdl.fk(7, direction, -newLoad)

    def setNewNormalLoad(self, normalLoadProperties, newLoad):
        if normalLoadProperties["type"] == "distributed":
            self.mapdl.nsel("S", "LOC", "Z", 0)
            self.mapdl.sf("ALL", "PRES", newLoad/(2 * (self.bf + self.zf) + self.bw))
            ...
            self.mapdl.fk(107, "FZ", -newLoad)
            self.mapdl.fk(107, "MX", ey * newLoad)
            self.mapdl.fk(107, "MY", ex * newLoad)
            self.mapdl.fk(7, "FZ", newLoad)
            self.mapdl.fk(7, "MX", - ey * newLoad)
            self.mapdl.fk(7, "MY", - ex * newLoad)